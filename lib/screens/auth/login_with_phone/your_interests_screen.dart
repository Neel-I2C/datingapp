...
know what you’re passionate about.''',
                      ...
                      GridView.builder(
                        ...
                        itemCount:
                            yourInterestsController.interestModel!.data!.length,
                        ...
                        itemBuilder: (context, index) {
                          return InkWell(
                            onTap: () {
                              setState(() {
                                yourInterestsController.selectedList.contains(
                                        yourInterestsController
                                            .interestModel!.data![index].id)
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                color: yourInterestsController.selectedList
                                        .contains(yourInterestsController
                                            .interestModel!.data![index].id)
